...
class UserFile(db.Model):
    ...
    point = db.Column(db.Integer, nullable=False, server_default=db.FetchedValue())
    date = db.Column(db.DateTime, nullable=False, server_default=db.FetchedValue())

    user = db.relationship('UserTable', primaryjoin='UserFile.user_id == UserTable.id', backref='user_files')

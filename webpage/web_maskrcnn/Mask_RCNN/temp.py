...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("trash", 1, "glass_bottle")
        self.add_class("trash", 2, "pet")
        self.add_class("trash", 3, "can")
        ...
        # Add images
        #aarray = {"can":1, "glass_bottle":2, "pet":3}
        aarray = {"glass_bottle": 1, "pet": 2, "can": 3}
        for a in annotations:
            ...
            class_ids = [aarray[n['name']] for n in objects]
